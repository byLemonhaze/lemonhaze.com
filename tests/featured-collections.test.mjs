...
test('featured collection manifests load complete, ordered galleries', async () => {
    ...
    assert.deepEqual(tinBox.map(item => item.name), ['Tin Box of Solitude', 'Reaching', 'Fisherman', 'Park Lane', 'Tea Pot', 'Bacon & Butcher', 'Hang On', 'Anywhere', '24/7', 'Late Night Shift', 'Lake Afternoon', 'Private Hours', 'Still Waiting']);
    ...
    assert.deepEqual(tinBox.map(item => item.inscription_number), [127360324, 127360428, 127360447, 127360460, 127373041, 127373179, 127373468, 127400582, 127402104, 127402275, 127402326, 127402340, 127402347]);
